        ...
        <div className="sidebar-logo">
          <div className="sidebar-logo-icon" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            {logoUrl ? (
              ...
              <img src="/assets/logo.png" alt="Logo" style={{ maxWidth: '36px', maxHeight: '36px', objectFit: 'contain' }} />
            )}
          </div>
...
axios.defaults.baseURL = import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:8080' : '');
