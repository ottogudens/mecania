...
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['localhost', '127.0.0.1', '.railway.app', '.skale.cl', '.railway.internal', 'mecania.railway.internal', 'mecania.railway.internal:8080', '*'])
